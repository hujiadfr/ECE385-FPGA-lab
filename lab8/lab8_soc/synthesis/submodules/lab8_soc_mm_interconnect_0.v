...
module lab8_soc_mm_interconnect_0 (
	...
	wire          cmd_mux_012_src_valid;                                                              // cmd_mux_012:src_valid -> sdram_pll_pll_slave_agent:cp_valid
	wire  [106:0] cmd_mux_012_src_data;                                                               // cmd_mux_012:src_data -> sdram_pll_pll_slave_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                              // sdram_pll_pll_slave_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [12:0] cmd_mux_012_src_channel;                                                            // cmd_mux_012:src_channel -> sdram_pll_pll_slave_agent:cp_channel
	wire          cmd_mux_012_src_startofpacket;                                                      // cmd_mux_012:src_startofpacket -> sdram_pll_pll_slave_agent:cp_startofpacket
	wire          cmd_mux_012_src_endofpacket;                                                        // cmd_mux_012:src_endofpacket -> sdram_pll_pll_slave_agent:cp_endofpacket
	...
	wire          sdram_pll_pll_slave_agent_rp_valid;                                                 // sdram_pll_pll_slave_agent:rp_valid -> router_014:sink_valid
	wire  [106:0] sdram_pll_pll_slave_agent_rp_data;                                                  // sdram_pll_pll_slave_agent:rp_data -> router_014:sink_data
	wire          sdram_pll_pll_slave_agent_rp_ready;                                                 // router_014:sink_ready -> sdram_pll_pll_slave_agent:rp_ready
	wire          sdram_pll_pll_slave_agent_rp_startofpacket;                                         // sdram_pll_pll_slave_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire          sdram_pll_pll_slave_agent_rp_endofpacket;                                           // sdram_pll_pll_slave_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire  [106:0] cmd_demux_001_src4_data;                                                            // cmd_demux_001:src4_data -> cmd_mux_012:sink0_data
	wire          cmd_demux_001_src4_ready;                                                           // cmd_mux_012:sink0_ready -> cmd_demux_001:src4_ready
	wire   [12:0] cmd_demux_001_src4_channel;                                                         // cmd_demux_001:src4_channel -> cmd_mux_012:sink0_channel
	...
	wire  [106:0] rsp_demux_012_src0_data;                                                            // rsp_demux_012:src0_data -> rsp_mux_001:sink4_data
	wire          rsp_demux_012_src0_ready;                                                           // rsp_mux_001:sink4_ready -> rsp_demux_012:src0_ready
	wire   [12:0] rsp_demux_012_src0_channel;                                                         // rsp_demux_012:src0_channel -> rsp_mux_001:sink4_channel
	...
	wire          sdram_pll_pll_slave_agent_rdata_fifo_src_valid;                                     // sdram_pll_pll_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_012:in_0_valid
	wire   [33:0] sdram_pll_pll_slave_agent_rdata_fifo_src_data;                                      // sdram_pll_pll_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_012:in_0_data
	wire          sdram_pll_pll_slave_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_012:in_0_ready -> sdram_pll_pll_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_012_out_0_valid;                                                  // avalon_st_adapter_012:out_0_valid -> sdram_pll_pll_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_012_out_0_data;                                                   // avalon_st_adapter_012:out_0_data -> sdram_pll_pll_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_012_out_0_ready;                                                  // sdram_pll_pll_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_012:out_0_ready
	wire    [0:0] avalon_st_adapter_012_out_0_error;                                                  // avalon_st_adapter_012:out_0_error -> sdram_pll_pll_slave_agent:rdata_fifo_sink_error
	...
	lab8_soc_mm_interconnect_0_router_014 router_014 (
