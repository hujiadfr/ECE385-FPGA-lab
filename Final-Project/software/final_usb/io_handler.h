...
//-----------------------Read More Keys-----------------------------------------//
#define keycode0_base           (volatile char*)    KEYCODE_0_BASE
#define keycode1_base			(volatile char*)	KEYCODE_1_BASE
#define keycode2_base			(volatile char*)	KEYCODE_2_BASE
#define keycode3_base			(volatile char*)	KEYCODE_3_BASE
#define keycode4_base			(volatile char*)	KEYCODE_4_BASE
#define keycode5_base			(volatile char*)	KEYCODE_5_BASE
#define keycode6_base			(volatile char*)	KEYCODE_6_BASE
#define keycode7_base			(volatile char*)    KEYCODE_7_BASE
//-------------------------------End--------------------------------------------//
