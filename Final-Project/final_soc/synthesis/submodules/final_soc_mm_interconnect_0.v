...
module final_soc_mm_interconnect_0 (
	...
	wire   [16:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> otg_hpi_w_s1_agent:cp_channel
	...
	wire   [16:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> otg_hpi_r_s1_agent:cp_channel
	...
	wire   [16:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> otg_hpi_data_s1_agent:cp_channel
	...
	wire   [16:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> otg_hpi_address_s1_agent:cp_channel
	...
	wire   [16:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> otg_hpi_reset_s1_agent:cp_channel
	...
	wire   [16:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> keycode_0_s1_agent:cp_channel
	...
	wire   [16:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> SDRAM_s1_agent:cp_channel
	...
	wire   [16:0] cmd_mux_011_src_channel;                                                            // cmd_mux_011:src_channel -> keycode_1_s1_agent:cp_channel
	...
	wire   [16:0] cmd_mux_012_src_channel;                                                            // cmd_mux_012:src_channel -> keycode_2_s1_agent:cp_channel
	...
	wire   [16:0] cmd_mux_013_src_channel;                                                            // cmd_mux_013:src_channel -> keycode_3_s1_agent:cp_channel
	...
	wire   [16:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> keycode_4_s1_agent:cp_channel
	...
	wire   [16:0] cmd_mux_015_src_channel;                                                            // cmd_mux_015:src_channel -> keycode_5_s1_agent:cp_channel
	...
	wire          cmd_mux_016_src_valid;                                                              // cmd_mux_016:src_valid -> sdram_pll_pll_slave_agent:cp_valid
	wire  [108:0] cmd_mux_016_src_data;                                                               // cmd_mux_016:src_data -> sdram_pll_pll_slave_agent:cp_data
	wire          cmd_mux_016_src_ready;                                                              // sdram_pll_pll_slave_agent:cp_ready -> cmd_mux_016:src_ready
	wire   [16:0] cmd_mux_016_src_channel;                                                            // cmd_mux_016:src_channel -> sdram_pll_pll_slave_agent:cp_channel
	wire          cmd_mux_016_src_startofpacket;                                                      // cmd_mux_016:src_startofpacket -> sdram_pll_pll_slave_agent:cp_startofpacket
	wire          cmd_mux_016_src_endofpacket;                                                        // cmd_mux_016:src_endofpacket -> sdram_pll_pll_slave_agent:cp_endofpacket
	...
	wire          sdram_pll_pll_slave_agent_rp_valid;                                                 // sdram_pll_pll_slave_agent:rp_valid -> router_018:sink_valid
	wire  [108:0] sdram_pll_pll_slave_agent_rp_data;                                                  // sdram_pll_pll_slave_agent:rp_data -> router_018:sink_data
	wire          sdram_pll_pll_slave_agent_rp_ready;                                                 // router_018:sink_ready -> sdram_pll_pll_slave_agent:rp_ready
	wire          sdram_pll_pll_slave_agent_rp_startofpacket;                                         // sdram_pll_pll_slave_agent:rp_startofpacket -> router_018:sink_startofpacket
	wire          sdram_pll_pll_slave_agent_rp_endofpacket;                                           // sdram_pll_pll_slave_agent:rp_endofpacket -> router_018:sink_endofpacket
	...
	wire          cmd_demux_001_src3_valid;                                                           // cmd_demux_001:src3_valid -> cmd_mux_016:sink0_valid
	wire  [108:0] cmd_demux_001_src3_data;                                                            // cmd_demux_001:src3_data -> cmd_mux_016:sink0_data
	wire          cmd_demux_001_src3_ready;                                                           // cmd_mux_016:sink0_ready -> cmd_demux_001:src3_ready
	wire   [16:0] cmd_demux_001_src3_channel;                                                         // cmd_demux_001:src3_channel -> cmd_mux_016:sink0_channel
	wire          cmd_demux_001_src3_startofpacket;                                                   // cmd_demux_001:src3_startofpacket -> cmd_mux_016:sink0_startofpacket
	wire          cmd_demux_001_src3_endofpacket;                                                     // cmd_demux_001:src3_endofpacket -> cmd_mux_016:sink0_endofpacket
	...
	wire          rsp_demux_016_src0_valid;                                                           // rsp_demux_016:src0_valid -> rsp_mux_001:sink3_valid
	wire  [108:0] rsp_demux_016_src0_data;                                                            // rsp_demux_016:src0_data -> rsp_mux_001:sink3_data
	wire          rsp_demux_016_src0_ready;                                                           // rsp_mux_001:sink3_ready -> rsp_demux_016:src0_ready
	wire   [16:0] rsp_demux_016_src0_channel;                                                         // rsp_demux_016:src0_channel -> rsp_mux_001:sink3_channel
	wire          rsp_demux_016_src0_startofpacket;                                                   // rsp_demux_016:src0_startofpacket -> rsp_mux_001:sink3_startofpacket
	wire          rsp_demux_016_src0_endofpacket;                                                     // rsp_demux_016:src0_endofpacket -> rsp_mux_001:sink3_endofpacket
	...
	wire   [16:0] cmd_demux_src10_channel;                                                            // cmd_demux:src10_channel -> crosser:in_channel
	...
	wire   [16:0] crosser_out_channel;                                                                // crosser:out_channel -> cmd_mux_010:sink0_channel
	...
	wire   [16:0] cmd_demux_001_src2_channel;                                                         // cmd_demux_001:src2_channel -> crosser_001:in_channel
	...
	wire   [16:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_010:sink1_channel
	...
	wire   [16:0] rsp_demux_010_src0_channel;                                                         // rsp_demux_010:src0_channel -> crosser_002:in_channel
	...
	wire   [16:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink10_channel
	...
	wire   [16:0] rsp_demux_010_src1_channel;                                                         // rsp_demux_010:src1_channel -> crosser_003:in_channel
	...
	wire   [16:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_001:sink2_channel
	...
	wire          sdram_pll_pll_slave_agent_rdata_fifo_src_valid;                                     // sdram_pll_pll_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_016:in_0_valid
	wire   [33:0] sdram_pll_pll_slave_agent_rdata_fifo_src_data;                                      // sdram_pll_pll_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_016:in_0_data
	wire          sdram_pll_pll_slave_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_016:in_0_ready -> sdram_pll_pll_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_016_out_0_valid;                                                  // avalon_st_adapter_016:out_0_valid -> sdram_pll_pll_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_016_out_0_data;                                                   // avalon_st_adapter_016:out_0_data -> sdram_pll_pll_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_016_out_0_ready;                                                  // sdram_pll_pll_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_016:out_0_ready
	wire    [0:0] avalon_st_adapter_016_out_0_error;                                                  // avalon_st_adapter_016:out_0_error -> sdram_pll_pll_slave_agent:rdata_fifo_sink_error
	...
	final_soc_mm_interconnect_0_router_018 router_018 (
	...
	final_soc_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		...
		.sink3_ready         (rsp_demux_016_src0_ready),                       //     sink3.ready
		.sink3_valid         (rsp_demux_016_src0_valid),                       //          .valid
		.sink3_channel       (rsp_demux_016_src0_channel),                     //          .channel
		.sink3_data          (rsp_demux_016_src0_data),                        //          .data
		.sink3_startofpacket (rsp_demux_016_src0_startofpacket),               //          .startofpacket
		.sink3_endofpacket   (rsp_demux_016_src0_endofpacket)                  //          .endofpacket
	);
